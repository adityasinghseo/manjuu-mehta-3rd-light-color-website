            ...
            {[
              ...
              <a key={i} href={href} target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = "0 8px 20px rgba(var(--color-accent-gold-rgb),0.25)";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.background = "rgba(255, 255, 255, 0.45)";
                  e.currentTarget.style.color = "var(--color-accent-gold)";
                  e.currentTarget.style.borderColor = "rgba(var(--color-accent-gold-rgb), 0.28)";
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 12 }}>
          {[
            ...
            <a key={i} href={href} target="_blank" rel="noopener noreferrer"
              ...
              onMouseEnter={e => {
                e.currentTarget.style.borderColor = "rgba(var(--color-accent-gold-rgb),0.45)";
                e.currentTarget.style.color = "var(--color-accent-gold)";
              ...
              onMouseLeave={e => {
                e.currentTarget.style.borderColor = "rgba(var(--color-accent-gold-rgb),0.22)";
                e.currentTarget.style.color = "rgba(58,32,16,0.72)";
                e.currentTarget.style.background = "rgba(255,255,255,0.50)";
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = "0 2px 8px rgba(var(--color-text-heading-rgb),0.01)";
              }}
            >
              {Icon ? (
                <Icon size={13} color="var(--color-accent-gold)" strokeWidth={1.5} />
              ) : (
