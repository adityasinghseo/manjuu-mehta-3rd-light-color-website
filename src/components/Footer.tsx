    ...
    <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", position: "relative", zIndex: 1 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(1, 1fr)", gap: 48, marginBottom: 64 }} className="footer-cols">
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          <h2 style={{ fontFamily: "Cinzel, serif", fontWeight: 800, fontSize: 17, color: "#8E6D3D", letterSpacing: "0.12em", marginBottom: 5 }}>
            MANJUU MEHTA
          </h2>
          <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 11, fontWeight: 500, color: "#8E6D3D", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 18 }}>
            Vastu ✦ Astrology ✦ Numerology
          </p>
          <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, color: "rgba(40,22,10,0.76)", lineHeight: 1.8, maxWidth: 300, marginBottom: 22 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          <h3 style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: 11.5, letterSpacing: "0.22em", textTransform: "uppercase", color: "#8E6D3D", marginBottom: 24, borderBottom: "1.5px solid rgba(142,109,61,0.30)", paddingBottom: 6, width: "100%", maxWidth: 160 }}>
            Navigation
          </h3>
          <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              ...
              <li key={link.to} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{ color: "#8E6D3D", fontSize: 8, userSelect: "none" }}>✦</span>
                <Link to={link.to}
                  style={{
      ...
      <div style={{ marginTop: 64, borderTop: "1px solid rgba(142,109,61,0.18)", paddingTop: 44 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 26, maxWidth: 460, margin: "0 auto 26px" }}>
          ...
          <p style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: 9.5, letterSpacing: "0.28em", textTransform: "uppercase", color: "#8E6D3D", flexShrink: 0 }}>
            Follow Me On
          </p>
      ...
      <div style={{ marginTop: 44, textAlign: "center", borderTop: "1px solid rgba(142,109,61,0.14)", paddingTop: 28 }}>
        <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 12, color: "rgba(40,22,10,0.52)", fontWeight: 400 }}>
          © {new Date().getFullYear()} Manjuu Mehta ✦ All Rights Reserved
        </p>
        <p style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: 10, letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(142,109,61,0.65)", marginTop: 6 }}>
          AIFAS Elite Member
        </p>
      </div>
    </div>
