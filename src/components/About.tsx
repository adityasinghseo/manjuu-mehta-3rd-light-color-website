...
const About = () => (
  <section
    ...
    style={{
      padding: "116px 0",
      background: "linear-gradient(180deg, #FAF0E4 0%, #FDF6EE 50%, #F5E6D2 100%)",
      position: "relative",
      overflow: "hidden",
    }}
  >
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", display: "grid", gridTemplateColumns: "1fr", gap: 64, alignItems: "center", position: "relative", zIndex: 2 }} className="about-grid">
      ...
      <div style={{ animation: "fadeUp 0.9s ease 0.15s both", display: "flex", flexDirection: "column", alignItems: "flex-start" }} className="about-text-col">
        ...
        <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 14.5, lineHeight: 1.95, color: "rgba(58,32,16,0.76)", marginBottom: 18, maxWidth: 580 }}>
          <strong style={{ color: "#C5922A", fontWeight: 600 }}>Manjuu Mehta</strong> is not just a consultant; she is a <strong style={{ color: "#C5922A", fontWeight: 600 }}>trusted guide on your path to harmony</strong>. With over a decade of dedicated practice, she beautifully blends the ancient sciences of <strong style={{ color: "#7B1034", fontWeight: 600 }}>Vastu Shastra, Vedic Astrology, and Karmic Numerology</strong> to bring clarity, emotional peace, and practical alignment to your everyday life.
        </p>
        <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 14.5, lineHeight: 1.95, color: "rgba(58,32,16,0.70)", marginBottom: 24, maxWidth: 580 }}>
          As an elite member of the prestigious <strong style={{ color: "#7B1034", fontWeight: 600 }}>All India Federation of Astrologers Society (AIFAS)</strong>, her precise consultations have transformed homes, corporate offices, and personal destinies across India and abroad — replacing stagnant obstacles with <strong style={{ color: "#C5922A", fontWeight: 600 }}>stunning prosperity and aligned growth</strong>.
        </p>
          ...
          {[
            ...
            <div key={s.l}
              style={{
                ...
                borderRadius: 16,
                backdropFilter: "blur(10px)",
                boxShadow: "0 6px 20px -8px rgba(91,10,36,0.05)",
                transition: "all 0.45s cubic-bezier(0.16, 1, 0.3, 1)",
              }}
              className="about-stat-card"
            >
              <div style={{ fontFamily: "Cinzel, serif", fontWeight: 900, fontSize: 26, color: "#7B1034", lineHeight: 1.0 }}>{s.n}</div>
              <div style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: 8, letterSpacing: "0.14em", textTransform: "uppercase", color: "#C5922A", marginTop: 8, lineHeight: 1.2 }}>{s.l}</div>
              <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 9, color: "rgba(58,32,16,0.55)", marginTop: 4, lineHeight: 1.3 }}>{s.desc}</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <style>{`
      ...
      .about-stat-card:hover {
        ...
        border-color: rgba(197, 146, 42, 0.55) !important;
        box-shadow: 0 12px 28px -6px rgba(91,10,36,0.08), 0 0 8px rgba(197,146,42,0.12) !important;
      }
