      ...
      <div style={{ textAlign: "center" }}>
        <Link
          ...
          style={{
            ...
            padding: "16px 36px",
            border: "1.5px solid rgba(var(--color-accent-gold-rgb),0.45)",
            borderRadius: 999,
            display: "inline-block",
            transition: "all 0.25s",
          }}
          onMouseEnter={e => { e.currentTarget.style.background = "var(--color-accent-gold)"; e.currentTarget.style.color = "#FFFFFF"; e.currentTarget.style.borderColor = "var(--color-accent-gold)"; }}
          onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--color-accent-gold)"; e.currentTarget.style.borderColor = "rgba(var(--color-accent-gold-rgb),0.45)"; }}
        >
          View Award Gallery →
        </Link>
      </div>
